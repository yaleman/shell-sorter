...
class TestSettings:
    ...
    def test_user_config_file_property(self, temp_data_dir: Path):
...
class TestConfigIntegration:
    ...
    def test_full_config_workflow(self, tmp_path: Path):
        ...
        with patch.object(Settings, 'get_config_path', return_value=config_file):
            ...
            user_config.network_camera_hostnames = ["esp32cam1.local", "esp32cam2.local"]
            ...
            assert loaded_config.network_camera_hostnames == ["esp32cam1.local", "esp32cam2.local"]
